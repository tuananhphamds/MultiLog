...
class PNLBertEuclideanAverage(BaseModel):
    def __init__(self, cfg, embedding_matrix, log_template_dict):
        super(PNLBertEuclideanAverage, self).__init__(cfg, embedding_matrix, log_template_dict)
    ...
    def _build_model(self):
        ...
        distance = tf.linalg.norm(average - trans_encoded[:, -1], axis=1)

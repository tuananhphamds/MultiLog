...
class PNLBertEuclideanLast(BaseModel):
    def __init__(self, cfg, embedding_matrix, log_template_dict):
        super(PNLBertEuclideanLast, self).__init__(cfg, embedding_matrix, log_template_dict)
    ...
    def _build_model(self):
        ...
        distances = tf.linalg.norm(trans_encoded[:, 0] - trans_encoded[:, -1], axis=1)
